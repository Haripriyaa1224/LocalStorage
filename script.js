...
// let phoneNo=prompt("Enter phone name");
...
// let newObjString=JSON.stringify(users);
// localStorage.setItem('user',newObjString);

// document.getElementById("first-name").textContent = newObjString.firstName;
